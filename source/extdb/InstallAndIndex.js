...
class InstallAndIndex {
    ...
    create(obj) {
        ...
        Helper.hasProperties(obj, ['username', 'filename', 'columns', 'mapping', 'keywords', 'filesystem'], true)
        ...
        return logstashConfig.initialize(lsConfig).then(() => {
            ...
            return ls.initializeLogstashFromMongoStdIn(obj.filesystem,
                obj.filename, obj.username, Helper.indexingNoForceWait);
